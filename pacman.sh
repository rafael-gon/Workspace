yay -S swayfx-git ly swaylock-effects qbittorrent discord pcsx2 \
prismlauncher yuzu melonds citra-git steam duckstation ppsspp \
dolphin-emu dropbox unzip unrar exa bat wget ttf-fira-code docker \
vlc flatpak viewnior mousepad thunar thunar thunar-archive-plugin \
